...
const FALLBACK_FAQ = [
    ...
    { id: 'fb-5', question: 'How do I message a neighbour?', answer: 'Open the Messages tab and tap New, or tap Message on a neighbour profile. Sharing works in one direction: you can start a conversation with a neighbour once they have shared their contact info with you, and they can always reply. Sharing your own details invites them to message you rather than the other way round. You can also message community groups in your neighbourhood.', sortOrder: '300', category: 'Messaging' },
    ...
    { id: 'fb-7', question: 'How do I share my contact info?', answer: 'Your email, phone, and address stay private until you choose to share them. Sharing goes one way: it lets that neighbour start a conversation with you, and you can reply. In a response thread tap Share Contact Info and tick exactly what to share. You can also turn on Auto-Share Contact Info when you create an ask or offer. You can stop sharing at any time, though details already emailed or saved cannot be taken back.', sortOrder: '600', category: 'Privacy & Account' },
